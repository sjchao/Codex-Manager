...
pub const APP_SETTING_GATEWAY_AGGREGATE_API_TEST_MODEL_KEY: &str =
    "gateway.aggregate_api_test_model";
pub const APP_SETTING_GATEWAY_CLAUDE_USER_AGENT_VERSION_KEY: &str =
    "gateway.claude_user_agent_version";
pub const APP_SETTING_GATEWAY_IMAGE_MODELS_KEY: &str = "gateway.image_models";
pub const APP_SETTING_GATEWAY_VIDEO_MODELS_KEY: &str = "gateway.video_models";
