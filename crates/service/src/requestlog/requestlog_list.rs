...
fn to_request_log_summary(item: RequestLog) -> RequestLogSummary {
    ...
    RequestLogSummary {
        ...
        upstream_actual_cost: item.upstream_actual_cost,
        upstream_total_cost: item.upstream_total_cost,
        upstream_duration_ms: item.upstream_duration_ms,
        upstream_first_response_ms: item.upstream_first_response_ms,
        upstream_usage_synced_at: item.upstream_usage_synced_at,
