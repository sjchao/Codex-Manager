...
| 聚合 API | `service_aggregate_api_create` | `aggregateApi/create` | 参数：`providerType`、`supplierName`、`sort`、`url`、`key` |
| 聚合 API | `service_aggregate_api_update` | `aggregateApi/update` | 参数：`id`、`providerType`、`supplierName`、`sort`、`url`、`key` |
